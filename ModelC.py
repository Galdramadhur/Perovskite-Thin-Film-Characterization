...
#Beginning of the AUAC pipeline; first, UV-Vis is extracted
os.chdir(UVVis_path)
...
#Thicknesses are read in and sorted
os.chdir(UVVis_path)
...
#UV-Vis data is devided by corresponding thickness; state_thickness_division ensures this is onyl run once
...
#AUAC is calculated via simpson integrals
area_list = []   
for i in range(len(UVV_list)):
...
#AUAC is averaged, normalized and its list is replicated for flip=1
avg_area_list = []
